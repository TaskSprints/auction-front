            ...
            <ul className="flex space-x-4">
              ...
              <li>
                <a
                  ...
                  className="hover:underline"
                >
                  <strong className="text-yellow-300">개인정보취급방침</strong>
                </a>
              </li>
              <li>
                <a
              ...
              <li className="cursor-pointer hover:underline">관리자쪽지</li>
              <li>
                <a
      ...
      <div className="border-t border-gray-700 pt-6">
        <div className="container mx-auto">
          <p className="text-gray-500 leading-6">
            ...
            <br />
            등록일 : 2015. 09. 7 | 통신판매업신고번호 : 대구시 제 000호 | 주소 :
            서울특별시 중구 세종대로 776-9번지 태정빌딩 3층
            <br />
            ...
            <br />
            Copyright 2024 해피온라인경매 Ver3.5 All rights reserved.
          </p>
        </div>
      </div>
    </div>
